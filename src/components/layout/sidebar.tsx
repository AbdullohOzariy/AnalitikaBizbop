...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/moliya/nazorat",       label: "Nazorat",       icon: ShieldAlert, roles: [SA, A, "CEO", "FINANCE"] },
      ...
      { href: "/moliya/malumotnoma",   label: "PQ Bo'limlari", icon: BookMarked,  roles: [SA, A, "CEO", "FINANCE"] },
